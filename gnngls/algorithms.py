...
import pdb
# sjy 
# from plot_tsp import plot_tsp_tour
...
# def local_search(init_tour, init_cost, D, t_lim, first_improvement=False):
...
def guided_local_search(G, init_tour, init_cost, t_lim, weight='weight', guides=['weight'], perturbation_moves=30,
    ...
    # cur_tour, cur_cost, search_progress = local_search(init_tour, init_cost, edge_weight, t_lim, first_improvement)
